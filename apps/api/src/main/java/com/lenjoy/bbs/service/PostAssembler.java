...
public class PostAssembler {
    ...
    public List<PostSummaryResponse> toSummaryList(List<PostEntity> posts) {
        ...
        return posts.stream().map(post -> toSummary(post, usernameMap.get(post.getAuthorId()))).toList();
    }
    ...
    private PostSummaryResponse toSummary(PostEntity post, String authorUsername) {
