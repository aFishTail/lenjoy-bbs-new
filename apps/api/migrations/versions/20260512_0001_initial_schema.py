...
def pk_col(name: str = "id") -> sa.Column:
...
def upgrade() -> None:
    ...
    op.create_table(
        "user_follow",
        pk_col(),
        sa.Column("follower_id", sa.Integer(), sa.ForeignKey("user_account.id"), nullable=False),
        sa.Column("following_id", sa.Integer(), sa.ForeignKey("user_account.id"), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.func.now(), nullable=False),
    ...
    op.create_table(
        "wallet",
        pk_col(),
        sa.Column("user_id", sa.Integer(), sa.ForeignKey("user_account.id"), nullable=False, unique=True),
    ...
    op.create_table(
        ...
        sa.Column("operated_by", sa.Integer()),
        sa.Column("created_at", sa.DateTime(), server_default=sa.func.now(), nullable=False),
    )
    op.create_table(
        "bbs_category",
    ...
    op.create_table(
        ...
        sa.Column("accepted_comment_id", sa.Integer()),
        ...
        sa.Column("offlined_by", sa.Integer()),
    ...
    op.create_table(
        ...
        sa.Column("tag_id", sa.Integer(), sa.ForeignKey("bbs_tag.id"), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.func.now(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("reply_to_user_id", sa.Integer()),
    ...
    op.create_table("post_like", pk_col(), sa.Column("post_id", sa.Integer(), sa.ForeignKey("bbs_post.id"), nullable=False), sa.Column("user_id", sa.Integer(), sa.ForeignKey("user_account.id"), nullable=False), sa.Column("created_at", sa.DateTime(), server_default=sa.func.now(), nullable=False), sa.UniqueConstraint("post_id", "user_id"))
    op.create_table("post_favorite", pk_col(), sa.Column("post_id", sa.Integer(), sa.ForeignKey("bbs_post.id"), nullable=False), sa.Column("user_id", sa.Integer(), sa.ForeignKey("user_account.id"), nullable=False), sa.Column("created_at", sa.DateTime(), server_default=sa.func.now(), nullable=False), sa.UniqueConstraint("post_id", "user_id"))
    op.create_table("comment_like", pk_col(), sa.Column("comment_id", sa.Integer(), sa.ForeignKey("post_comment.id"), nullable=False), sa.Column("user_id", sa.Integer(), sa.ForeignKey("user_account.id"), nullable=False), sa.Column("created_at", sa.DateTime(), server_default=sa.func.now(), nullable=False), sa.UniqueConstraint("comment_id", "user_id"))
    op.create_table(
        "resource_purchase",
        pk_col(),
        sa.Column("post_id", sa.Integer(), sa.ForeignKey("bbs_post.id"), nullable=False),
        sa.Column("buyer_id", sa.Integer(), sa.ForeignKey("user_account.id"), nullable=False),
        sa.Column("seller_id", sa.Integer(), sa.ForeignKey("user_account.id"), nullable=False),
    ...
    op.create_table(
        "resource_appeal",
        pk_col(),
        sa.Column("purchase_id", sa.Integer(), sa.ForeignKey("resource_purchase.id"), nullable=False, unique=True),
